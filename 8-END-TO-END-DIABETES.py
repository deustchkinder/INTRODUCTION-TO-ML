...
def grab_col_names(dataframe,cat_th=10,car_th=20):
    ...
    Not:Kategorik değişkenlerinin içerisine numerik görünümlü kategorik değişkenler de dahildir.
    ...
    ----
        ...
        Return olan 3 liste toplamı değişken sayısına eşittir:cat_cols + num_cols + cat_but_cat = değişken sayısı    
    """    
    ...
    # print(f'num_but_cat:{len(num_but_car)}')
...
#Kategorik değişkenlerinin incelenmesi
for col in cat_cols:
    cat_summary(df,col)
...
#Sayısal değişkenlerinin birbiriyle korelasyonu
...
#4-AUTOMATED HYPERPARAMETERS OPTİMİZATİON
...
#6-PREDİCTİON FOR A NEW OBSERVATİON
